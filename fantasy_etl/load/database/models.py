...
完整迁移自 scripts/model.py，包含所有Yahoo Fantasy数据库模型定义。
...
from sqlalchemy import create_engine, Column, Integer, String, Boolean, DateTime, JSON, ForeignKey, Index, Date, text, Float, Numeric
