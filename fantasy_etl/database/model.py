try:
    ...
    # 如果 SQLAlchemy 不可用，提供基础的空实现
    create_engine = None
    Column = Integer = String = Boolean = DateTime = JSON = None
    ForeignKey = Index = Date = text = Float = ForeignKeyConstraint = Numeric = None
    declarative_base = sessionmaker = relationship = None
